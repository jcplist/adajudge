...
const parser = new Parser({
  description: 'Copy submissions of problem id y in homework id x (exclude admin & TA) before deadline to /home/ada/adajudge2023/moss/x_y/'
});
...
(async () => {
  ...
  const folder = `/home/ada/adajudge2023/moss/${args.homework_id}_${args.problem_id}`;
