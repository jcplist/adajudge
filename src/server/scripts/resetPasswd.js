...
var _user = _interopRequireDefault(require("/home/ada/adajudge2023/dist/model/user"));
...
const resetUser = async (email, transporter) => {
  ...
  await user.save();
  const text = `Welcome to ADA2023, this email is to inform you that your ADA Judge account has been created.
...
`;
  const mailOptions = {
    from: '"ada2023" <ada-ta@csie.ntu.edu.tw>',
    to: email,
    subject: '[ADA2023] Your ADA Judge Account',
    text
  };
